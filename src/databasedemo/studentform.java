...
public class studentform extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "SELECT Student", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Tahoma", 1, 18))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        statementString = "SELECT * FROM Etud WHERE matricule_etu = ?";
        ...
        if (flag == true)  {
            try {
                ...
                final  String matricule_etu = resultSet.getString("matricule_etu");
                final  String prenom_etu = resultSet.getString("prenom_etu");
                final  String date_naissance = resultSet.getString("date_naissance");
                JOptionPane.showMessageDialog(null, "name : " + nom_etu + "\n" + "matricule : " + matricule_etu + "\n prenom : " + prenom_etu + "\n date de naissance : " + date_naissance );
            }
