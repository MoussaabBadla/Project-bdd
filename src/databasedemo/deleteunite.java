...
public class deleteunite extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "Delete Unite", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Tahoma", 1, 18))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String slqCmnd = "DELETE FROM EtudUnite WHERE code_unite = ?";
        ...
        if (flag == true)  {
            try {
                ...
                int unites =statement.executeUpdate();
                System.out.println(unites + " unites deleted");


                slqCmnd = "DELETE FROM Unite WHERE code_unite = ?";

                statement=connection.prepareStatement(slqCmnd);

                statement.setString(1, setString);
                unites =statement.executeUpdate();



                System.out.println(unites + " unites deleted");
                displayMessage("" + unites + " unites deleted");
            }
