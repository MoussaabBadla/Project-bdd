...
public class deleteTeacher extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "Delete Teacher", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Tahoma", 1, 18))); // NOI18N

        jLabel1.setFont(new java.awt.Font("Tahoma", 3, 15)); // NOI18N
        jLabel1.setText("Teacher Matricule");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(id.equals("")==true)    {
            ...
            setString = id;
        String slqCmnd = "DELETE FROM EtudUnite WHERE code_Unite IN (SELECT code_Unite FROM Unite WHERE matricule_ens = ?)";
        ...
        if (flag == true)  {
            try {
                ...
                statement=connection.prepareStatement(slqCmnd);
                statement.setString(1, setString);
                int techers =statement.executeUpdate();

                slqCmnd = "DELETE FROM Unite WHERE matricule_ens = ?" ;

                statement=connection.prepareStatement(slqCmnd);

                statement.setString(1, setString);
                 techers =statement.executeUpdate();
                 System.out.println(techers + " Unit deleted");

                statementString = "DELETE FROM Enseignant where matricule_ens  = ?";
                ...
                System.out.println(techers + " Teacher deleted");
                displayMessage("" + techers + " Teacher deleted");
            }
    ...
    private void displayError(Exception err)   {
        ...
        jTextField3.setForeground(new java.awt.Color(255, 0, 0));
        jTextField3.setEnabled(true);
        jTextField3.setText(err.toString().split(":")[2]);
    }
